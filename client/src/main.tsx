...
// Layout renders <LiveMonitor>/<ZoneConfigPage> itself, permanently mounted
// and just CSS-toggled by route — see Layout.tsx's comment for why:
// ZoneConfigPage's AI/motion detection loops must keep running when the
